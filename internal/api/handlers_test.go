...
func TestCreateTask_RejectsRemovedReadModeFields(t *testing.T) {
	srv := testServer(t)

	for _, body := range []string{
		`{"prompt":"fix bug in https://github.com/test/repo","force":true}`,
		`{"prompt":"fix bug in https://github.com/test/repo","inline_content":"# stale"}`,
		`{"prompt":"fix bug in https://github.com/test/repo","branch":"codex/fix-bug"}`,
		`{"prompt":"fix bug in https://github.com/test/repo","target_branch":"develop"}`,
	} {
